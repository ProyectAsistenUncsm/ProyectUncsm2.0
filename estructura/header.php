              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  ...
                  <div class="pull-right">
                    <a href="mains/Alumnos_controlador.php?op=salir" class="btn btn-default btn-flat">Salir Alumno</a>
                  </div>
                </li>
              </ul>
            </li>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="mains/asistencia_alumnos.php"><i class="fa fa-circle-o"></i> Asistencias de Alumnos</a></li>
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  ...
                  <li><a href="mains/rptasistencia_alumnos.php"><i class="fa fa-circle-o"></i> Reporte de Alumnos</a></li>
                </ul>
              </li>
            </ul>
          </li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="mains/index.php"><i class="fa fa-circle-o"></i> Alumnos</a></li>
            </ul>
          </li>
